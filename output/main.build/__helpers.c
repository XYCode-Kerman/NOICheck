...
PyObject *CALL_FUNCTION_WITH_ARGS76(PyThreadState *tstate, PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 76); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 76 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 76; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(tstate, function,  (PyObject **)args );
        } else if (function->m_args_simple && 76 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 76 * sizeof(PyObject *));
            memcpy(python_pars + 76, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 76);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 76);
            ...
            if (function->m_args_simple && 76 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[76 + 1];
                ...
                result = function->m_c_code(tstate, function, python_pars);
            } else if (function->m_args_simple && 76 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 76 * sizeof(PyObject *));
                memcpy(python_pars+1 + 76, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 76);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            ...
            PyObject *pos_args = MAKE_TUPLE(args, 76);
            ...
            Py_DECREF(pos_args);
                ...
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 76, NULL);
#else
            PyObject *pos_args = MAKE_TUPLE(args, 76);
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 76);
            Py_DECREF(pos_args);
#endif
            } else {
            PyObject *pos_args = MAKE_TUPLE(args, 76);
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 76, NULL);
#endif
        CHECK_OBJECT_X(result);
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 76);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS76(tstate, init_method, args);
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 76, NULL);
